    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="sm:p-5 bg-white shadow sm:rounded-lg">
          ...
          <!-- Formulário -->
          <form @submit.prevent="form.put(route('usuarios.update', usuario.id))" class="w-full  mt-6">
            <!-- Nome -->
            <div class="mb-4">
            ...
            <!-- Admin -->
            <div class="mb-4">
              <Checkbox id="admin" v-model="form.admin" :checked="form.admin ? true : false" />
